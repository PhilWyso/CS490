...
echo 'processing inputs as args<br>';
for($i=0;$i<$count;$i++)
{
	$buff=explode(',',$in[$i]);
  	echo exec("python ./add.py $buff[0] $buff[1]");
	echo '<br>';
}

//---------
echo 'from your old code<br>';
for($i=0;$i<$count;$i++)
{
  $ans=$out[$i];
  ...
  echo exec("python ./grade.py middle");
  echo '<br>';
  //var_dump($output);
